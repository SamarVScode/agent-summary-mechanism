      ...
      <div className="agent-picker-card">
        <div className="agent-picker-header">
          <div className="app-logo" style={{ marginBottom: '24px' }}>
            <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" style={{ display: "block", margin: "0 auto" }}>
              <path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"></path>
              <rect x="8" y="2" width="8" height="4" rx="1" ry="1"></rect>
            </svg>
          </div>
          <h1 className="agent-picker-title">AgentFlow</h1>
          <p className="card-subtitle">Performance & Payout Portal</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="login-form">
          ...
          {error && <div className="toast" style={{ position: 'relative', top: 0, transform: 'none', marginBottom: '16px', width: '100%' }}>{error}</div>}
          ...
          <button
            ...
            disabled={loading}
          >
            {loading ? "Authenticating..." : "Login to AgentFlow"}
          </button>
        </form>
      </div>
    </div>
